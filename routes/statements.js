...
router
	...
	.post(
		...
		validateStatement,
		catchAsync(statements.createStatement)
	);
...
router.get("/handbook", statements.renderHandbook);
...
router
	...
	.put(
		...
		upload.array("pdfFile"),
		validateStatement,
		catchAsync(statements.updateStatement)
	)
...
router.get(
	"/:id/editSegments",
	isLoggedIn,
	catchAsync(statements.renderEditSegmentsForm)
);
